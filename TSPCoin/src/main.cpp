...
// Copyright (c) 2013 The TSPCoin developers
...
uint256 hashGenesisBlock("0x00000fe60b9fb252bde1f22a86213b260d2967c3dc0576b1718813305e62f912");
static const unsigned int timeGenesisBlock = 1465398303;
...
const string strMessageMagic = "TSPCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 60 * 1000000; // readjust difficulty once per hour
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "already in already databases we TSPCoin from USA with reindexing.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xfacaa12d8dd4f23187b69dca4c57faf72321267f0deb23956e9e73f853e1d593"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TSPCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TSPCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("TSPCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("TSPCoin-miner");
    ...
    try { loop {
        ...
        printf("Running TSPCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("TSPCoinMiner terminated\n");
        throw;
    }
}
