...
const QString BITCOIN_IPC_PREFIX("TSPCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click TSPCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start TSPCoin: click-to-pay handler");
    else
...
{
    // clicking on TSPCoin: URLs creates FileOpen events on the Mac:
